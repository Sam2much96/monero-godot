...
void CPUParticles2D::___init_method_bindings() {
	___mb.mb__texture_changed = godot::api->godot_method_bind_get_method("CPUParticles2D", "_texture_changed");
	...
	godot::api->godot_string_name_new_data(&class_name, "CPUParticles2D");
