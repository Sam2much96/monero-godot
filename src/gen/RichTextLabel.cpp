...
void *RichTextLabel::_detail_class_tag = nullptr;
...
void RichTextLabel::___init_method_bindings() {
	...
	___mb.mb_is_fit_content_height_enabled = godot::api->godot_method_bind_get_method("RichTextLabel", "is_fit_content_height_enabled");
	...
	___mb.mb_set_fit_content_height = godot::api->godot_method_bind_get_method("RichTextLabel", "set_fit_content_height");
	...
	godot::api->godot_string_name_new_data(&class_name, "RichTextLabel");
