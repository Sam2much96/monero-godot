...
void *RigidBody::_detail_class_tag = nullptr;
...
void RigidBody::___init_method_bindings() {
	...
	___mb.mb_get_inverse_inertia_tensor = godot::api->godot_method_bind_get_method("RigidBody", "get_inverse_inertia_tensor");
	...
	godot::api->godot_string_name_new_data(&class_name, "RigidBody");
