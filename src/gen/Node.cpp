...
void Node::___init_method_bindings() {
	...
	___mb.mb_get_node_internal = godot::api->godot_method_bind_get_method("Node", "get_node");
	...
	godot::api->godot_string_name_new_data(&class_name, "Node");
...
Node *Node::get_node_internal(const NodePath path) const {
	return (Node *) ___godot_icall_Object_NodePath(___mb.mb_get_node_internal, (const Object *) this, path);
}
