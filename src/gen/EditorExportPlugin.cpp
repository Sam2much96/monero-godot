...
void *EditorExportPlugin::_detail_class_tag = nullptr;
...
void EditorExportPlugin::___init_method_bindings() {
	...
	___mb.mb_add_ios_embedded_framework = godot::api->godot_method_bind_get_method("EditorExportPlugin", "add_ios_embedded_framework");
	...
	___mb.mb_add_ios_project_static_lib = godot::api->godot_method_bind_get_method("EditorExportPlugin", "add_ios_project_static_lib");
	...
	godot::api->godot_string_name_new_data(&class_name, "EditorExportPlugin");
...
void EditorExportPlugin::add_ios_embedded_framework(const String path) {
	___godot_icall_void_String(___mb.mb_add_ios_embedded_framework, (const Object *) this, path);
}
...
void EditorExportPlugin::add_ios_project_static_lib(const String path) {
	___godot_icall_void_String(___mb.mb_add_ios_project_static_lib, (const Object *) this, path);
}
