...
void Tree::___init_method_bindings() {
	...
	___mb.mb_edit_selected = godot::api->godot_method_bind_get_method("Tree", "edit_selected");
	...
	___mb.mb_scroll_to_item = godot::api->godot_method_bind_get_method("Tree", "scroll_to_item");
	...
	godot::api->godot_string_name_new_data(&class_name, "Tree");
