...
void *GeometryInstance::_detail_class_tag = nullptr;
...
void GeometryInstance::___init_method_bindings() {
	...
	___mb.mb_get_generate_lightmap = godot::api->godot_method_bind_get_method("GeometryInstance", "get_generate_lightmap");
	___mb.mb_get_lightmap_scale = godot::api->godot_method_bind_get_method("GeometryInstance", "get_lightmap_scale");
	...
	___mb.mb_set_generate_lightmap = godot::api->godot_method_bind_get_method("GeometryInstance", "set_generate_lightmap");
	___mb.mb_set_lightmap_scale = godot::api->godot_method_bind_get_method("GeometryInstance", "set_lightmap_scale");
	...
	godot::api->godot_string_name_new_data(&class_name, "GeometryInstance");
...
GeometryInstance::LightmapScale GeometryInstance::get_lightmap_scale() const {
	return (GeometryInstance::LightmapScale) ___godot_icall_int(___mb.mb_get_lightmap_scale, (const Object *) this);
}
