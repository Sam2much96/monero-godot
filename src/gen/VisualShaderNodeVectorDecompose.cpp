...
VisualShaderNodeVectorDecompose::___method_bindings VisualShaderNodeVectorDecompose::___mb = {};

void *VisualShaderNodeVectorDecompose::_detail_class_tag = nullptr;

void VisualShaderNodeVectorDecompose::___init_method_bindings() {
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "VisualShaderNodeVectorDecompose");
