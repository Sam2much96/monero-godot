...
void *PacketPeerUDP::_detail_class_tag = nullptr;

void PacketPeerUDP::___init_method_bindings() {
	___mb.mb_close = godot::api->godot_method_bind_get_method("PacketPeerUDP", "close");
	___mb.mb_connect_to_host = godot::api->godot_method_bind_get_method("PacketPeerUDP", "connect_to_host");
	...
	___mb.mb_is_connected_to_host = godot::api->godot_method_bind_get_method("PacketPeerUDP", "is_connected_to_host");
	...
	godot::api->godot_string_name_new_data(&class_name, "PacketPeerUDP");
