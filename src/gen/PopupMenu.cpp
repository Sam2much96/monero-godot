...
void *PopupMenu::_detail_class_tag = nullptr;
...
void PopupMenu::___init_method_bindings() {
	...
	___mb.mb_get_current_index = godot::api->godot_method_bind_get_method("PopupMenu", "get_current_index");
	...
	godot::api->godot_string_name_new_data(&class_name, "PopupMenu");
...
void PopupMenu::add_separator(const String label, const int64_t id) {
	___godot_icall_void_String_int(___mb.mb_add_separator, (const Object *) this, label, id);
}
