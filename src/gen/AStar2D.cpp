...
void AStar2D::___init_method_bindings() {
	___mb.mb__compute_cost = godot::api->godot_method_bind_get_method("AStar2D", "_compute_cost");
	___mb.mb__estimate_cost = godot::api->godot_method_bind_get_method("AStar2D", "_estimate_cost");
	...
	godot::api->godot_string_name_new_data(&class_name, "AStar2D");
