...
void *LineEdit::_detail_class_tag = nullptr;
...
void LineEdit::___init_method_bindings() {
	...
	___mb.mb_delete_char_at_cursor = godot::api->godot_method_bind_get_method("LineEdit", "delete_char_at_cursor");
	___mb.mb_delete_text = godot::api->godot_method_bind_get_method("LineEdit", "delete_text");
	...
	___mb.mb_get_scroll_offset = godot::api->godot_method_bind_get_method("LineEdit", "get_scroll_offset");
	...
	___mb.mb_is_virtual_keyboard_enabled = godot::api->godot_method_bind_get_method("LineEdit", "is_virtual_keyboard_enabled");
	...
	___mb.mb_set_virtual_keyboard_enabled = godot::api->godot_method_bind_get_method("LineEdit", "set_virtual_keyboard_enabled");
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "LineEdit");
