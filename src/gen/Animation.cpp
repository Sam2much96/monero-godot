...
void Animation::___init_method_bindings() {
	...
	___mb.mb_value_track_interpolate = godot::api->godot_method_bind_get_method("Animation", "value_track_interpolate");
	___mb.mb_value_track_set_update_mode = godot::api->godot_method_bind_get_method("Animation", "value_track_set_update_mode");
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "Animation");
