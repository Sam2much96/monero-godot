...
void *AnimationNodeStateMachine::_detail_class_tag = nullptr;
...
void AnimationNodeStateMachine::___init_method_bindings() {
	...
	___mb.mb_replace_node = godot::api->godot_method_bind_get_method("AnimationNodeStateMachine", "replace_node");
	...
	godot::api->godot_string_name_new_data(&class_name, "AnimationNodeStateMachine");
...
void AnimationNodeStateMachine::replace_node(const String name, const Ref<AnimationNode> node) {
	___godot_icall_void_String_Object(___mb.mb_replace_node, (const Object *) this, name, node.ptr());
}
