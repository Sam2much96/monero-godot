...
Color Control::get_color(const String name, const String node_type) const {
...
int64_t Control::get_constant(const String name, const String node_type) const {
...
Ref<Font> Control::get_font(const String name, const String node_type) const {
...
Ref<Texture> Control::get_icon(const String name, const String node_type) const {
...
Ref<StyleBox> Control::get_stylebox(const String name, const String node_type) const {
...
bool Control::has_color(const String name, const String node_type) const {
...
bool Control::has_constant(const String name, const String node_type) const {
...
bool Control::has_font(const String name, const String node_type) const {
...
bool Control::has_icon(const String name, const String node_type) const {
...
bool Control::has_stylebox(const String name, const String node_type) const {
