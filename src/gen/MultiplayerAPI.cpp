...
void *MultiplayerAPI::_detail_class_tag = nullptr;
...
void MultiplayerAPI::___init_method_bindings() {
	...
	___mb.mb_get_root_node = godot::api->godot_method_bind_get_method("MultiplayerAPI", "get_root_node");
	...
	godot::api->godot_string_name_new_data(&class_name, "MultiplayerAPI");
