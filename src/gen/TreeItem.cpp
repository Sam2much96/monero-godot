...
void *TreeItem::_detail_class_tag = nullptr;
...
void TreeItem::___init_method_bindings() {
	...
	___mb.mb_get_suffix = godot::api->godot_method_bind_get_method("TreeItem", "get_suffix");
	...
	___mb.mb_set_suffix = godot::api->godot_method_bind_get_method("TreeItem", "set_suffix");
	...
	godot::api->godot_string_name_new_data(&class_name, "TreeItem");
