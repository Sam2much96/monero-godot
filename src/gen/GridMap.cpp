...
void *GridMap::_detail_class_tag = nullptr;
...
void GridMap::___init_method_bindings() {
	...
	___mb.mb_get_use_in_baked_light = godot::api->godot_method_bind_get_method("GridMap", "get_use_in_baked_light");
	...
	___mb.mb_set_use_in_baked_light = godot::api->godot_method_bind_get_method("GridMap", "set_use_in_baked_light");
	___mb.mb_world_to_map = godot::api->godot_method_bind_get_method("GridMap", "world_to_map");
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "GridMap");
