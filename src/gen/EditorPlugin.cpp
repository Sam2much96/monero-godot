...
void *EditorPlugin::_detail_class_tag = nullptr;
...
void EditorPlugin::___init_method_bindings() {
	...
	___mb.mb_forward_spatial_draw_over_viewport = godot::api->godot_method_bind_get_method("EditorPlugin", "forward_spatial_draw_over_viewport");
	___mb.mb_forward_spatial_force_draw_over_viewport = godot::api->godot_method_bind_get_method("EditorPlugin", "forward_spatial_force_draw_over_viewport");
	...
	godot::api->godot_string_name_new_data(&class_name, "EditorPlugin");
