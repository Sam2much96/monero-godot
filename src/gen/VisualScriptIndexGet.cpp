...
VisualScriptIndexGet::___method_bindings VisualScriptIndexGet::___mb = {};

void *VisualScriptIndexGet::_detail_class_tag = nullptr;

void VisualScriptIndexGet::___init_method_bindings() {
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "VisualScriptIndexGet");
