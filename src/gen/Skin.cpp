...
void Skin::___init_method_bindings() {
	...
	___mb.mb_get_bind_name = godot::api->godot_method_bind_get_method("Skin", "get_bind_name");
	...
	___mb.mb_set_bind_name = godot::api->godot_method_bind_get_method("Skin", "set_bind_name");
	___mb.mb_set_bind_pose = godot::api->godot_method_bind_get_method("Skin", "set_bind_pose");
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "Skin");
