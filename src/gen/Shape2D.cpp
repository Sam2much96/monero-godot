...
void Shape2D::___init_method_bindings() {
	...
	___mb.mb_draw = godot::api->godot_method_bind_get_method("Shape2D", "draw");
	...
	godot::api->godot_string_name_new_data(&class_name, "Shape2D");
...
void Shape2D::draw(const RID canvas_item, const Color color) {
	___godot_icall_void_RID_Color(___mb.mb_draw, (const Object *) this, canvas_item, color);
}
