...
void *RandomNumberGenerator::_detail_class_tag = nullptr;
...
void RandomNumberGenerator::___init_method_bindings() {
	...
	___mb.mb_get_state = godot::api->godot_method_bind_get_method("RandomNumberGenerator", "get_state");
	...
	___mb.mb_set_state = godot::api->godot_method_bind_get_method("RandomNumberGenerator", "set_state");
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "RandomNumberGenerator");
