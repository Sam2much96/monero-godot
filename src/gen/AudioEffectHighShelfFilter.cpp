...
AudioEffectHighShelfFilter::___method_bindings AudioEffectHighShelfFilter::___mb = {};

void *AudioEffectHighShelfFilter::_detail_class_tag = nullptr;

void AudioEffectHighShelfFilter::___init_method_bindings() {
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "AudioEffectHighShelfFilter");
