...
void Image::___init_method_bindings() {
	...
	___mb.mb_load_bmp_from_buffer = godot::api->godot_method_bind_get_method("Image", "load_bmp_from_buffer");
	...
	___mb.mb_load_tga_from_buffer = godot::api->godot_method_bind_get_method("Image", "load_tga_from_buffer");
	...
	___mb.mb_save_png_to_buffer = godot::api->godot_method_bind_get_method("Image", "save_png_to_buffer");
	...
	godot::api->godot_string_name_new_data(&class_name, "Image");
