...
void *DynamicFont::_detail_class_tag = nullptr;
...
void DynamicFont::___init_method_bindings() {
	...
	___mb.mb_get_available_chars = godot::api->godot_method_bind_get_method("DynamicFont", "get_available_chars");
	...
	godot::api->godot_string_name_new_data(&class_name, "DynamicFont");
