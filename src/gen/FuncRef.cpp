...
void *FuncRef::_detail_class_tag = nullptr;
...
void FuncRef::___init_method_bindings() {
	...
	___mb.mb_get_function = godot::api->godot_method_bind_get_method("FuncRef", "get_function");
	...
	godot::api->godot_string_name_new_data(&class_name, "FuncRef");
